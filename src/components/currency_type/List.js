              ...
              <CTable bordered>
                <CTableHead>
                  <CTableRow>
                    ...
                    <CTableHeaderCell scope="col">Currency Name</CTableHeaderCell>
                    <CTableHeaderCell scope="col">USD Rate</CTableHeaderCell>
                ...
                <CTableBody>
                  {items.map((item) => (
                    <CTableRow key={item.id}>
                      ...
                      <CTableDataCell>{item.usd_rate}</CTableDataCell>
